...
def test_epub_chapter_reorder_manifest_matches_the_in_image_manifest() -> None:
    ...
    assert parsed == dataclasses.replace(EpubChapterReorderPlugin.manifest, transport="local_exec")
