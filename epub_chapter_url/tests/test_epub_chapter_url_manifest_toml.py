...
def test_epub_chapter_url_manifest_matches_the_in_image_manifest() -> None:
    ...
    assert parsed == dataclasses.replace(EpubChapterUrlPlugin.manifest, transport="local_exec")
