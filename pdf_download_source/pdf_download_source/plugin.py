...
class PdfDownloadSourcePlugin:
    ...
    def claims(self, url: str) -> bool:
        """Claim absolute URLs whose path ends in ``.pdf`` (any case; query and fragment ignored) — the same rule as the manifest's ``url_patterns``, which is what the core applies out of process."""
